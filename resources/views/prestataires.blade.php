...
<section class="section">
    ...
    <div class="grid">
        ...
        <div class="card">
            <img src="{{ asset('images/fatou.png') }}" alt="Fatou">
        ...
        <div class="card">
            <img src="{{ asset('images/amy.png') }}" alt="Amy">
            <div class="card-content">
                <h3>Amy</h3>
        ...
        <div class="card">
            <img src="{{ asset('images/marieme.png') }}" alt="Marième">
            <div class="card-content">
                <h3>Marième</h3>
        ...
        <div class="card">
            <img src="{{ asset('images/omar.png') }}" alt="Omar">
            <div class="card-content">
                <h3>Omar</h3>
